...
// Timeout corto: si el servicio Java aun no esta corriendo, la pagina no se queda colgada esperando
$contexto_java  = stream_context_create(['http' => ['timeout' => 1]]);
$respuesta_java = @file_get_contents($url_java, false, $contexto_java);
...
.order-select option { background: var(--surface); color: var(--text); padding: 8px; }
