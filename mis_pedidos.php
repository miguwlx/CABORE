    ...
    <div class="pedido-card" id="card-<?= $pedido['id'] ?>">
        ...
        <div class="pedido-body <?= ($ultimo_pedido == $pedido['id']) ? 'open' : '' ?>" id="body-<?= $pedido['id'] ?>">
            ...
            <div style="margin-top:14px;text-align:right">
                <a href="factura.php?id=<?= $pedido['id'] ?>" target="_blank" class="btn-primary" style="text-decoration:none;display:inline-flex;align-items:center;gap:6px;padding:8px 16px;font-size:.82rem">
                    <i class="fas fa-file-invoice"></i> Ver / descargar factura
                </a>
            </div>
        </div>
